...
const CandidateById = () => {
  ...
  const getStageInfo = (stageId) => {
    return stages.find((s) => s.id === stageId) || { name: stageId, color: "bg-gray-100 text-gray-800" };
  };
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-900">{new Date(candidate.appliedAt).toLocaleDateString()}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-500">Last Updated:</span>
                <p className="text-sm text-gray-900">{new Date(candidate.updatedAt).toLocaleDateString()}</p>
              </div>
              {candidate.phone && (
                <div>

...
import { useNavigate, useParams } from "react-router-dom"; // changed here
...
const CandidatesByJob = () => {
  ...
  const { id } = useParams(); // job id from URL like /jobs/:id/candidates

  const jobFilter = id || ""; // treat id as jobFilter

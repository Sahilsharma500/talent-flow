...
import { getJobStatistics } from '../db/jobsDB.js';
import { getCandidateStatistics } from '../db/candidateDB.js';
import { getAssessmentStatistics } from '../db/assessmentsDB.js';
import { getApplicationStatistics } from '../db/candidateDB.js';
